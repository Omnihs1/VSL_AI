...
if __name__ == '__main__':
    ...
    # Dataset class
    train_dataset = FeederINCLUDE(data_path=f"data/vsl100_train_data_preprocess.npy", label_path=f"data/vsl100_train_label_preprocess.npy",
    ...
    # Trainer PL
    trainer = pl.Trainer(max_epochs = 100, accelerator="gpu", check_val_every_n_epoch = 1, 
