...
if __name__ == '__main__':
    file, label = np.load("data/vsl100_train_data_preprocess.npy"), np.load("data/vsl100_train_label_preprocess.npy")
    print(file.shape, label.shape)
    data = FeederINCLUDE(data_path=f"data/vsl100_train_data_preprocess.npy", label_path=f"data/vsl100_train_label_preprocess.npy",
                            transform=None)
